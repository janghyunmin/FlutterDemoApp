...
import 'package:flutter_demo_app/viewmodels/news_article_view_model.dart';

class NewsDetailScreen extends StatelessWidget {
  final NewsArticleViewModel newsArticleViewModel;

  const NewsDetailScreen({Key? key, required this.newsArticleViewModel})
      : super(key: key);
  @override
        ...
        child: Column(
          children: [
            ...
            Align(
              ...
              child: Text(
                newsArticleViewModel.publishedAt ?? '',
